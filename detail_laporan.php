...
include "server.php";
	...
	$id_checkout=$_GET["id"];
    $data = pg_query("select check_out.id_checkout, tamu.nama_tamu, tipe_kamar.nama_tipekamar, kamar.no_kamar, check_in.tgl_in,check_out.waktu_checkout, kamar_checkin.lama, tipe_kamar.harga, kamar_checkin.total_makan, kamar_checkin.total_laundry, check_out.tagihan
			...
			and kamar_checkin.id_checkin=check_in.id_checkin and kamar_checkin.id_in=check_out.id_in and check_out.id_checkout='".$id_checkout."'");
