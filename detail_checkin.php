...
include "server.php";
    ...
    $data = pg_query("select check_in.id_checkin, tamu.nama_tamu, tamu.no_identitas,tamu.alamat,tipe_kamar.nama_tipekamar , check_in.tgl_in, check_in.tgl_out, check_in.status
			from tamu, check_in, tipe_kamar where tamu.kd_tamu=check_in.kd_tamu and tipe_kamar.kd_tipekamar=check_in.kd_tipekamar and check_in.id_checkin='".$id_checkin."'");
